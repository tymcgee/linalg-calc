...
class Fraction:
    ...
    def __add__(self, n):
        if isinstance(n, Fraction):
            ...
            return Fraction(num, denom)
        elif isinstance(n, (int, float, np.floating, np.integer)):
    ...
    def __lt__(self, n):
        ...
        elif isinstance(n, (int, float, np.integer, np.floating)):
    ...
    def __eq__(self, n):
        ...
        #     return n == str(self)
        else: return False # if n isn't a number or fraction, then it's not equal
    ...
    def __ne__(self, n):
        ...
        # elif isinstance(n, str):
        #     return n != str(self)
        else: return True # if n isn't a number or fraction, then it's not equal
...
def get_frac_from_string(st):
    ...
    elif len(a) == 1: # a is either int or float
        if '.' in a[0]:
...
def dec_to_frac_approx(n, accuracy=0.0001):
    """ converts floating number n to a fraction object approximation using the Stern-Brocot Tree. """
